...
document.addEventListener('DOMContentLoaded', function() {
  ReactDOM.render(
    React.createElement(Tetris, {rows: rows, columns: columns}),
    document.getElementById('tetris')
  );  
});

},{"./tetris.jsx":168,"react":165,"react-dom":28}],167:[function(require,module,exports){
var React = require('react');
...
var Square = React.createClass({displayName: "Square",
  ...
  render: function () {
    ...
    return (React.createElement("span", {className: square}));
  }
});
...
var Row = React.createClass({displayName: "Row",
  render: function () {
    ...
    var squares = this.props.row.map(function (square) {
      return (React.createElement(Square, {key: key++, blank: square}));
    }); 
    return (React.createElement("div", {className: "row"}, squares));
  }
});
...
var Tetris = React.createClass({displayName: "Tetris",
  ...
  render: function () {
    ...
    var rows = board.map(function (row) {
      return (React.createElement(Row, {key: key++, row: row}));
    });
    ...
    React.createElement("div", {class: "col-sm-8"}, 
